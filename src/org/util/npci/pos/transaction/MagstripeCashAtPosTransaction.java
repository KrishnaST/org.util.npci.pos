...
public final class MagstripeCashAtPosTransaction extends IssuerTransaction<POSDispatcher> {

	protected static final String CVD_TAG = "054";
	protected static final String TYPE    = "ICASHATPOS";

	public MagstripeCashAtPosTransaction(final ISO8583Message request, final POSDispatcher dispatcher) {
