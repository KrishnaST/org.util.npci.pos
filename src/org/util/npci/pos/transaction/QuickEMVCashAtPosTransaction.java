...
public final class QuickEMVCashAtPosTransaction extends IssuerTransaction<POSDispatcher> {

	protected static final String CVD_TAG = "054";
	protected static final String TYPE    = "PURCHASE";

	public QuickEMVCashAtPosTransaction(final ISO8583Message request, final POSDispatcher dispatcher) {
